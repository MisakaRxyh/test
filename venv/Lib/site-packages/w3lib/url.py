...
def urljoin_rfc(base, ref, encoding='utf-8'):
    ...
    >>> import w3lib.url
    >>> w3lib.url.urljoin_rfc('http://www.example.com/path/simple.html', u'/otherpath/index2.html')
    'http://www.example.com/otherpath/index2.html'
    >>>

    >>> # Note: the following does not work in Python 3
    >>> w3lib.url.urljoin_rfc(b'http://www.example.com/path/simple.html', u'fran\u00e7ais/d\u00e9part.htm') # doctest: +SKIP
